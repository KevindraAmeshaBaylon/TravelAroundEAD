...
public class HotelManagementForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtHotelLocation = new javax.swing.JTextField();
        ...
        jLabel1.setText("TravelAround Add New Hotel");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtHotelLocation, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    // 1. Defensively prevent processing empty form fields on update operations
    if (name.isEmpty() || location.isEmpty() || ratingStr.isEmpty()) {
        javax.swing.JOptionPane.showMessageDialog(this, "Please select a row first or make sure all updated input fields are filled.");
        return;
    }
    ...
    try {
        ...
        // 2. Enforce explicit architectural rating layout limits
        if (rating < 1.0 || rating > 5.0) {
            javax.swing.JOptionPane.showMessageDialog(this, "Rating must be a numerical decimal value between 1.0 and 5.0.");
            return;
        }
        ...
        if (hotelController.updateHotel(hotelId, name, location, rating)) {
            ...
            // Clear fields post-update
            txtHotelName.setText("");
            txtHotelLocation.setText("");
            txtHotelRating.setText("");
        }
    } catch (NumberFormatException e) {
        javax.swing.JOptionPane.showMessageDialog(this, "Invalid rating input layout. Please check that your star rating is a proper decimal.");
    }
    ...
    private javax.swing.JTextField txtHotelLocation;
